// Challenge 1
// 1. Modify the function is Windy and return true if the speed
//is greater than 5 and false if not
// 2. Call the function and alert ‘It is windy’ if it is windy, Else,
...
let speed = prompt("Speed of wind ?");
